	...
	<header>
		...
		<nav class="navbar navbar-expand-sm navbar-dark ">
			<div class="container-fluid">
				<div>
					<a class="navbar-brand" href="/asm/adminn"> <img
				...
				<div class="collapse navbar-collapse" id="mynavbar">
					<ul class="navbar-nav me-auto">
						...
						<li class="nav-item"><a class="nav-link"
							href="/asm/videomanager/index">Video</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/asm/usermanager/index">User</a></li>
						<li class="nav-item"><a class="nav-link" href="/asm/report">Report</a></li>
					</ul>
					<div class="nav-icon">
