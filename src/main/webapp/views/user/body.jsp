...
<body>
	<div id="root">
		<div class="app">
			<header class="banner"
				style="background-size: cover; background-image: url('https://image.tmdb.org/t/p/original//hVMoqvXs5j9ffun56tZ5YhliSD9.jpg'); background-position: center center;">
				<div class="banner__contents">
					<h1 class="banner__title">Ginny &amp; Georgia</h1>
					<div class="banner__buttons">
						<button class="banner__button">Play</button>
						<button class="banner__button">More</button>
					</div>
					<h1 class="banner__description">Angsty and awkward fifteen
						year old Ginny Miller often feels more mature than her thirty year
						old mother, the irresistible and dynamic Georgia Miller...</h1>
				</div>
				...
				<div class="row__posters">
					<c:forEach var="item" items="${homes }">
						<div class="lazy row__poster row__posterLarge ">
							<a href="/asm/userr/detail"
								onclick="event.preventDefault(); window.location.href='/asm/userr/detail?id=${item.id}'">
